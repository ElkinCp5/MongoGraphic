...
const EditableFormRow = Form.create()(EditableRow);
  ...
  class EditableTable extends Component {
        ...
        this.columns.push({
            ...
            render: (text, record) =>
              this.state.dataSource.length >= 1 ? (
                <Popconfirm title="Sure to delete?" onConfirm={() => this.handleDelete(record.name, record)}>
                  <a>Delete</a>
                </Popconfirm>
              ) : null,
        });
    ...
    handleDelete = (name, info = undefined) => {
        console.log(info);
        console.log(name);
...
export default Form.create({ name: 'normal_table' })(EditableTable);
